...
function altysier_enqueue_assets() {
	...
	// Core theme CSS (serve optimized minified CSS with cache busting)
	$css_rel = file_exists( get_template_directory() . '/assets/css/styles.min.css' ) ? '/assets/css/styles.min.css' : '/assets/css/styles.css';
